package Percobaan.Kalkulator;

public class Kalkulator1841720116zakhy extends javax.swing.JFrame {
    double a;
    double b;
    String operation;
    double result;
   
    public Kalkulator1841720116zakhy() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kalkulator1841720116zakhy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kalkulator1841720116zakhy().setVisible(true);
            }
        });
    }
