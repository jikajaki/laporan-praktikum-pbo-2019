 ...
 */
public class TampilGui1841720116zakhy extends javax.swing.JFrame {
    DefaultTableModel TabMahasiswa;
    InputData1841720116zakhy DataMahasiswa;

    /**
     * Creates new form TampilGui
     */
    public TampilGui1841720116zakhy() {
        DataMahasiswa = new InputData1841720116zakhy();
        initComponents();
        LihatDataMahasiswa();
    }
    ...
    public final void LihatDataMahasiswa() {
        ...
        int i = 0;
        for(Mahasiswa1841720116zakhy mhs: DataMahasiswa.getData()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilGui1841720116zakhy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilGui1841720116zakhy().setVisible(true);
            }
        });
    }
