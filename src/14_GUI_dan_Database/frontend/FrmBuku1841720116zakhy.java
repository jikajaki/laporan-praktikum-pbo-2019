 ...
 * @author AHMADMUZAKHY
 */
public class FrmBuku1841720116zakhy extends javax.swing.JFrame {

    /**
     * Creates new form FrmBuku
     */
    public FrmBuku1841720116zakhy() {
        initComponents();
        tampilkanData();
    ...
    public void tampilkanData() {
        ...
        ArrayList<Buku1841720116zakhy> list = new Buku1841720116zakhy().getAll();
    ...
    public void cari(String keyword) {
        ...
        ArrayList<Buku1841720116zakhy> list = new Buku1841720116zakhy().search(keyword);
        Object rowData[] = new Object[5];
        
        tblBuku.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Buku1841720116zakhy buku : list) {
    ...
    public void tampilkanCmbKategori () {
        cmbKategori.setModel(new DefaultComboBoxModel(new Kategori1841720116zakhy().getAll().toArray()));
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        buku.setKategori((Kategori1841720116zakhy)cmbKategori.getSelectedItem());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Buku1841720116zakhy buku = new Buku1841720116zakhy().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        buku.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuku1841720116zakhy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuku1841720116zakhy().setVisible(true);
            }
        });
    }
