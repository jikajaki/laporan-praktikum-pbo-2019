...
public class FrmPeminjaman1841720116zakhy extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman
     */
    public FrmPeminjaman1841720116zakhy() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        ArrayList<Peminjaman1841720116zakhy> list = new Peminjaman1841720116zakhy().getAll();
    ...
    public void cariAnggota(String keyword){
        Anggota1841720116zakhy anggota = new Anggota1841720116zakhy().getById(Integer.parseInt(keyword));
        jLabel6.setText("Nama Anggota : "+anggota.getNama());
    }
    
    public void cariBuku(String keyword){
        Buku1841720116zakhy buku = new Buku1841720116zakhy().getById(Integer.parseInt(keyword));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1841720116zakhy pmj = new Peminjaman1841720116zakhy();
        pmj.setIdpeminjaman(Integer.parseInt(txtIdPeminjaman.getText()));
        
        Anggota1841720116zakhy anggota = new Anggota1841720116zakhy().getById(Integer.parseInt(txtIdAnggota.getText()));
        Buku1841720116zakhy buku = new Buku1841720116zakhy().getById(Integer.parseInt(txtIdBuku.getText()));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720116zakhy pmj = new Peminjaman1841720116zakhy().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pmj.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720116zakhy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720116zakhy().setVisible(true);
            }
        });
    }
