...
public class FrmKategori1841720116zakhy extends javax.swing.JFrame {
    ...
    public void tampilkanData(){
        ...
        ArrayList<Kategori1841720116zakhy> list = new Kategori1841720116zakhy().getAll();
        Object rowData[] = new Object[3];
        
        tblKategori.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Kategori1841720116zakhy kat : list){
    ...
    public void cari(String keyword){
        String[] kolom = {"ID", "Nama", "Keterangan"};
        ArrayList<Kategori1841720116zakhy> list = new Kategori1841720116zakhy().search(keyword);
        Object rowData[] = new Object[3];
     ...
     */
    public FrmKategori1841720116zakhy() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Kategori1841720116zakhy kat = new Kategori1841720116zakhy().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmKategori1841720116zakhy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmKategori1841720116zakhy().setVisible(true);
            }
        });
    }
