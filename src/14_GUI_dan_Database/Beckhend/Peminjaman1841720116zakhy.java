 ...
 * @author AHMADMUZAKHY
 */
public class Peminjaman1841720116zakhy {
    private int idpeminjaman;
    private Anggota1841720116zakhy anggota = new Anggota1841720116zakhy();
    private Buku1841720116zakhy buku = new Buku1841720116zakhy();
    private String tanggalpinjam;
    private String tanggalkembali;

    public Peminjaman1841720116zakhy() {
    }

    public Peminjaman1841720116zakhy(Anggota1841720116zakhy anggota, Buku1841720116zakhy buku, String tanggalpinjam, String tanggalkembali) {        
    ...
    public Anggota1841720116zakhy getAnggota() {
        return anggota;
    }

    public void setAnggota(Anggota1841720116zakhy anggota) {
        this.anggota = anggota;
    }

    public Buku1841720116zakhy getBuku() {
        return buku;
    }

    public void setBuku(Buku1841720116zakhy buku) {
        this.buku = buku;
    }
    ...
    public Peminjaman1841720116zakhy getById(int id){
        Peminjaman1841720116zakhy peminjaman = new Peminjaman1841720116zakhy();
        ...
        try {
            while(rs.next()){
                peminjaman = new Peminjaman1841720116zakhy();
    ...
    public ArrayList<Peminjaman1841720116zakhy> getAll(){
        ArrayList<Peminjaman1841720116zakhy> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720116zakhy.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
                                        +"      p.tanggalkembali AS tanggalkembali, "
    ...
    public ArrayList<Peminjaman1841720116zakhy> search(String keyword){
        ArrayList<Peminjaman1841720116zakhy> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720116zakhy.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
    ...
    public void save(){
        if(getById(idpeminjaman).getIdpeminjaman()== 0){
            String SQL = "INSERT INTO peminjaman (idanggota, idbuku, tanggalpinjam, tanggalkembali) VALUES("
                    ...
                    +"      '"+ this.tanggalkembali + "' "
                    +"      )";
            this.idpeminjaman = DBHelper1841720116zakhy.insertQueryGetId(SQL);
